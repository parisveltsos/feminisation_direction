...
cd GO_UP
Rscript ~/git/rana_transcriptome/scripts/GO_BP.R ../GO_universe.txt GO_pvalues_UP.txt out_BP 0.05
Rscript ~/git/rana_transcriptome/scripts/GO_CC.R ../GO_universe.txt GO_pvalues_UP.txt out_CC 0.05
Rscript ~/git/rana_transcriptome/scripts/GO_MF.R ../GO_universe.txt GO_pvalues_UP.txt out_MF 0.05
echo -e 'GO category\tGO\tTerm\tAnnotated\tSignificant\tExpected\ttopGO (Fisher)\tclassic (Fisher)' > header_temp.txt
cat table_Fisherout_BP | cut -f 1,2,3,4,5,7,9 | grep -v topgo |  perl -pe 's/^/BP\t/' > table_Fisherout_BP_temp
cat table_Fisherout_CC | cut -f 1,2,3,4,5,7,9 | grep -v topgo |  perl -pe 's/^/CC\t/' > table_Fisherout_CC_temp
cat table_Fisherout_MF | cut -f 1,2,3,4,5,7,9 | grep -v topgo |  perl -pe 's/^/MF\t/' > table_Fisherout_MF_temp
...
cd GO_DOWN
Rscript ~/git/rana_transcriptome/scripts/GO_BP.R ../GO_universe.txt GO_pvalues_DOWN.txt out_BP 0.05
Rscript ~/git/rana_transcriptome/scripts/GO_CC.R ../GO_universe.txt GO_pvalues_DOWN.txt out_CC 0.05
Rscript ~/git/rana_transcriptome/scripts/GO_MF.R ../GO_universe.txt GO_pvalues_DOWN.txt out_MF 0.05
echo -e 'GO category\tGO\tTerm\tAnnotated\tSignificant\tExpected\ttopGO (Fisher)\tclassic (Fisher)' > header_temp.txt
cat table_Fisherout_BP | cut -f 1,2,3,4,5,7,9 | grep -v topgo |  perl -pe 's/^/BP\t/' > table_Fisherout_BP_temp
cat table_Fisherout_CC | cut -f 1,2,3,4,5,7,9 | grep -v topgo |  perl -pe 's/^/CC\t/' > table_Fisherout_CC_temp
cat table_Fisherout_MF | cut -f 1,2,3,4,5,7,9 | grep -v topgo |  perl -pe 's/^/MF\t/' > table_Fisherout_MF_temp
